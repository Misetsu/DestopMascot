...
class DemoWin(QMainWindow):
    def __init__(self):
        ...
        icon = "1.jpg"
        # 右键菜单
        quit_action = QAction(u'退出', self)
        quit_action.setIcon(QIcon(icon))
        show = QAction(u'显示', self)
    ...
    def enterEvent(self, event):  # 鼠标移进时调用
        ...
        Qt.UpArrowCursor 向上的箭头            Qt.SizeBDiaCursor  斜向上双箭头
        Qt.IBeamCursor   I形状                 Qt.SizeFDiaCursor  斜向下双箭头
